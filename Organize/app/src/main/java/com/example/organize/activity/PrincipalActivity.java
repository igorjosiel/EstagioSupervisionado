...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void excluirMovimentacao(RecyclerView.ViewHolder viewHolder)
    {
        ...
        alertDialog.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapterMovimentacao.notifyItemRemove(position);
        ...
        alertDialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapterMovimentacao.notifyDataSetChange();
            }
        });
    ...
    public void atualizarSaldo()
    {
        ...
        {
            desepesaTotal = desepesaTotal - movimentacao.getValor();

            usuarioRef.child("despesaTotal").setValue(desepesaTotal);
        }
    }
    ...
    public void configuraCalendarView()
    {
        ...
        mesAnoSelecionado = String.valueOf(mesSelecionado) + "" + dataAtual.getMonth() + "" + dataAtual.getYear();
        ...
        calendarView.setOnMonthChangedListener(new OnMonthChangedListener() {
            ...
            public void onMonthChanged(MaterialCalendarView widget, CalendarDay date) {
                ...
                mesAnoSelecionado = String.valueOf(date.getMonth() + 1) + "" + date.getMonth() + "" + date.getYear();
