        ...
        botaoEntrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!textoEmail.isEmpty())
                {
                    ...
                    {
                        Toast.makeText(LoguinActivity.this, "Preencha o senha!", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(LoguinActivity.this, "Preencha o email!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

    public void validarLoguin()
    {
